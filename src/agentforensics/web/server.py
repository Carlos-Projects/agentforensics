...
async def _load_sample_on_startup() -> None:
    """Load sample data into memory for demo purposes."""
    sample_events = [
        {
            "source": "mcpguard",
        ...
        },
        {
            ...
            "description": "Agent exceeded request rate limit",
            "target": "rate_limit",
            "blocked": True,
    ...
    for ev in sample_events:
        ev["raw"] = {}
        ev_copy = dict(ev)
        _engine.ingest_structured(ev_copy)
